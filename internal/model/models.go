...
type Conversation struct {
	...
	Channel          string         `gorm:"type:text;not null;default:'';comment:来源通道(空=控制台;dingtalk=钉钉机器人)" json:"channel,omitempty"`
	ChannelSessionID string         `gorm:"type:text;not null;default:'';comment:通道内会话ID(钉钉 conversationId)" json:"channel_session_id,omitempty"`
